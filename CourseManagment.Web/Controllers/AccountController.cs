...
namespace CourseManagment.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IStudentService std)
        {
            studentService = std;
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.FirstName+" "+model.SecondName, Email = model.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    studentService.AddStudent(new BLL.DTOModels.StudentDTO
                    {
                        FirstName = model.FirstName,
                        SecondName = model.SecondName,
                        StudentTerm = model.Term,
